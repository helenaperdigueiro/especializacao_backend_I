...
import com.dh.courseservice.config.CustomLoadBalancerConfiguration;
...
@LoadBalancerClient(name = "subscription-service", configuration= CustomLoadBalancerConfiguration.class)
